...
public class StringAddCalculatorTest {
    ...
    void test_빈문자열_null_0반환(String given) {
        StringNumber stringNumber = StringNumber.from(given);

        StringAddCalculator stringAddCalculator = StringAddCalculator.from(stringNumber);
    ...
    void test_숫자_세개_합_구분자_두개() {
        StringAddCalculator stringAddCalculator = StringAddCalculator.from(StringNumber.from("1,2:3"), ",|:");
